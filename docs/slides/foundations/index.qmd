...
![](assets/images/ferret.svg){width=100%}
...
<table>
<tr>
<td><div style="transform: translate(50px, -40px);"><i class="fa-solid fa-bolt fa-2x fa-rotate-90"></i></div></td>
<td><i class="fa-solid fa-dna fa-5x"></i></td>
</tr>
</table>
...
Mutations are generated randomly as changes in DNA. In WF model will be highlighted in black.
...
![](assets/images/gould_finches.jpg){width=700px}
