...
#| echo: false
#| eval: true
#| file: ../../recipes/slides/foundations/hwe.R
#| fig-height: 6
#| fig-width: 12
#| fig-cap:
...
#|     [{{< fa rectangle-list >}}]({{< var recipes.baseurl >}}#sec-recipe-slides-hwe)
```
...
### Probability that two sequences pick same parent {#sec-prob-sequence-pick-same-parent}
...
**fixed**, which ultimately means variation is **lost** with drift
...
#| out-width: 80%
#| fig-cap: |
#|     Histogram showing the course of change of the gene
...
#| fig-height: 12
#| fig-cap: |
#|    Random drift in replicate experimental populations
...
distributions. This observation led Kimura to apply diffusion theory
to obtain probability densities of allele frequencies, leading in turn
to compact expressions of fixation probabilities, expected ages of
alleles, and more. A treatment of diffusion theory is outside the
scope of this course; the interested reader can consult e.g.,
[@warrenewens_MathematicalPopulationGenetics_2006].
...
Equation presented without details. Derivation by
...
![](assets/images/gould_finches.jpg){width=700px fig-align=center}
...
In red region ($|N_es|<0.005$) the probability of fixation is within
...
For genes, the ratio of non-synonymous to synonymous substitutions can
...
## Recombination breaks coupling between sites   {visibility="hidden" .unnumbered .unlisted}

1. illustration of recombination
2. illustration from Gillespie with alleles and outcomes

## Linkage disequilibrium  {visibility="hidden" .unnumbered .unlisted}

1. LD distribution plot, preferably from 1000 genomes
...
## Recombination breaks up association between loci
