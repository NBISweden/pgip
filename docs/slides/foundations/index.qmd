...
$p^\prime$ because different genotypes affects survival probabilities.
...
#|     positive selection.
#|     [{{< fa rectangle-list >}}](
#|     {{< var recipes.baseurl >}}#sec-recipe-slides-dn-ds-ratio-human-rat)
...
![](https://humanbiology.pressbooks.tru.ca/wp-content/uploads/sites/6/2019/06/MajorEventsInMeiosis_variant_int-1536x921.png){width=80% fig-align=center}
...
\node[right of=o1_east] (f1) {$p_AB$};
\node at (g.mid -| f1) {Frequencies};
\node[right of=o2_east] (f2) {$p_ab$};
\node[right of=o3_east] (f3) {$p_Ab$};
\node[right of=o4_east] (f4) {$p_aB$};
...
#|     [{{< fa rectangle-list >}}]({{< var recipes.slimurl
