...
<h3>Calculate the nucleotide diversity</h3>
...
$0.49$ and $0.09$ for $AA$ and $aa$, and hence, the frequency of $Aa$ is
$1 - 0.49 - 0.09 = 0.42 = 0.21 + 0.21 = 2pq$
...
![](assets/images/flower-red.svg){width=30}
![](assets/images/flower-white.svg){width=30}
![](assets/images/flower-white.svg){width=30}
![](assets/images/flower-white.svg){width=30}
![](assets/images/flower-white.svg){width=30}
![](assets/images/flower-white.svg){width=30}
...
may change and fix due to chance alone and not selection.
...
The general idea nearly neutral theory is that most mutations are
...
![](assets/images/meiosis.png){width=80% fig-align=center}
