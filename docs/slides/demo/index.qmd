...
Many examples make use of **[fenced divs](https://quarto.org/docs/authoring/markdown-basics.html#divs-and-spans)**. For more information on quarto markdown syntax, see **[Markdown Basics](https://quarto.org/docs/authoring/markdown-basics.html#divs-and-spans)**.
...
Alternatively columns can be setup using the [bootstrap css grid](https://getbootstrap.com/docs/5.1/layout/css-grid/) layout
...
[2023 • [SciLifeLab](https://www.scilifelab.se/) • [NBIS](https://nbis.se/) • [RaukR](https://nbisweden.github.io/workshop-RaukR-2306/)]{.smallr}
