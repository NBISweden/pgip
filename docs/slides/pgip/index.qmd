...
FIXME: end by listing some applications (see
<https://link-springer-com.ezproxy.its.uu.se/book/10.1007/978-3-030-04589-0#toc>)

- conservation genomics (corals, Matt's bees -> segue to his talk)
- speciation genomics (Monkeyflower paper)
- disentangle forces that create variation (Monkeyflower; great apes)
- epigenomics (corona virus)
- paloegenomics (aDNA)
- GWAS
- domestication
- ecology
