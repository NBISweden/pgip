...
on statistical inference in population genomics
@johri_StatisticalInferencePopulation_2021. In it, the authors
point out that whereas historically theoretical advances outpaced
data production, that is no longer true due to the advent of
