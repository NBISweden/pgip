...
>}}/demography/dataset/ALL.bamlist`). You will also need
`/proj/naiss2023-22-1084/private/demography/dataset/anc.fa.gz`, which
has the ancestral state for your individuals. Let's calculate the
unfolded SFS.
