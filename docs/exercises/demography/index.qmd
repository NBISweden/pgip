...
This exercise is divided into two parts. The first part will happen on Rackham. All the files you need are located here: ```{{< var uppmaxproject >}}```, inside the directory `/demography`. The second part will happen inside R Studio locally.
