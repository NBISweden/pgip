...
You will run most analyses on Rackham, so just go to your directory to start.
...
```         
interactive -A naiss2023-22-1084 -t 4:00:00 -n 10
```
...
You will need your file that has a list with all BAM files from all individuals from all populations (`/proj/naiss2023-22-1084/private/demography/dataset/ALL.bamlist`). You will also need `/proj/naiss2023-22-1084/private/demography/dataset/anc.fa.gz`, which has the ancestral state for your individuals. Let's calculate the unfolded SFS.
...
Alright, now you need to have this .Rmd file and all outputs in the same directory. You can copy to your machine. Or you can remote access it somewhere. It's up to you.
