...
```{r, engine='tikz', fig.ext="svg", engine.opts=font_opts}
...
\pic {coverageplot={\coveragetable}{ref}{A1}{A1}{Sample 1}{blue}};
\matrix[mask, anchor=west, at={($(A1.south west)+(3pt, -10pt)$)}] (A1mask) {\Aonemask};

\pic[yshift=-100pt] {coverageplot={\coveragetable}{ref}{A2}{A2}{Sample 2}{blue}};
\matrix[mask, anchor=west, at={($(A2.south west)+(3pt, -10pt)$)}] (A2mask) {\Atwomask};

\pic[yshift=-200pt] {coverageplot={\coveragetable}{ref}{A3}{A3}{Sample 3}{blue}};
\matrix[mask, anchor=west, at={($(A3.south west)+(3pt, -10pt)$)}] (A3mask) {\Athreemask};

\pgfplotsset{covaxis/.append style={ymax=45}}
\pic[xshift=200pt, yshift=-120pt] {coverageplot={\coveragetable}{ref}{Asum}{Asum}{All samples}{red}};
