...
located on linkage group 4, and we will be using both a 3Mbp region of
interest (ROI) surronding the locus, and the whole linkage group, for
different exercises.
...
accessed remotely through [https://export.uppmax.uu.se/{{<
var uppmaxproject >}}/](<https://export.uppmax.uu.se/{{><
var uppmaxproject >}}/).
