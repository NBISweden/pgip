...
On UPPMAX, the command to run `picard` is `java -jar
$PICARD_HOME/picard.jar`. The UPPMAX command version is included as a
comment whenever there is a command running `picard`. Make sure to
uncomment when copying the code.
